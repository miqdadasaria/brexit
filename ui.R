...
shinyUI(pageWithSidebar(
				...
				sidebarPanel(
				   ...
				   selectInput("imputation", "Missing sample size imputation:",
				              list("Mean" = "mean", 
				                   "Minumum" = "min", 
				                   "Exclude" = "complete"), selected="min"),
				  
				   sliderInput("prop_leave_vote", "Proportion of leave voters polled who will actually vote", min=0, max=1, value=0.6),
				   
				   sliderInput("prop_remain_vote", "Proportion of remain voters polled who will actually vote", min=0, max=1, value=0.65),
				   
				   sliderInput("prop_und_vote", "Proportion of undecided voters polled who will actually vote", min=0, max=1, value=0.3),
						
						sliderInput("prop_und_remain", "Proportion of undecided voters who will actually vote who will vote to remain", min=0, max=1, value=0.8),

						selectInput("time_wts", "Time weighting method:",
						            list("Exponential" = "exponential", 
						                 "Linear" = "linear", 
						                 "None" = "none"), selected="linear"),
